...
CREATE PROCEDURE [App].[Feature_Select_ByNearestNeighbor]
    ...
    @latitude float =  33.9595924,
    @longitude float = -84.4651686,
    @distanceInKilometers INT =  50 ,
    @StatePostalCode VARCHAR(2) = 'GA',
...
EXEC [App].[Feature_Select_ByNearestNeighbor]  -- use defaults;
